...
import PrintBanner1 from '@/disign-pattern/adapter/PrintBanner1';
import PrintBanner2 from '@/disign-pattern/adapter/PrintBanner2';
import Display from '@/disign-pattern/decorator/Display';
import StringDisplay from '@/disign-pattern/decorator/StringDisplay';
import SideBorder from '@/disign-pattern/decorator/SideBorder';
import FullBorder from '@/disign-pattern/decorator/FullBorder';
import AbstractDisplay from '@/disign-pattern/template/AbstractDisplay';
import CharDisplay from '@/disign-pattern/template/CharDisplay';
import TextDisplay from '@/disign-pattern/template/TextDisplay';
import TextBuilder from '@/disign-pattern/builder/TextBuilder';
import Director from '@/disign-pattern/builder/Director';
import HtmlBuilder from '@/disign-pattern/builder/HtmlBuilder';
